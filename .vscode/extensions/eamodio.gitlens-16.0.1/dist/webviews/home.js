...
`,ei="state";class HomeStateProvider{constructor(e,t,o){this._ipc=o,this.state=t,this.provider=new context_provider_i(e,{context:ei,initialValue:t}),this.disposable=this._ipc.onReceiveMessage((t=>{switch(!0){case Ne.is(t):this.state.repositories=t.params,this.state.timestamp=Date.now(),this.provider.setValue(this.state,!0);break;case We.is(t):this.state.repositories=t.params.repositories,this.state.discovering=t.params.discovering,this.state.timestamp=Date.now(),this.provider.setValue(this.state,!0);break;case je.is(t):this.state.walkthroughProgress=t.params,this.state.timestamp=Date.now(),this.provider.setValue(this.state,!0);break;case Ue.is(t):this.state.subscription=t.params.subscription,this.state.avatar=t.params.avatar,this.state.organizationsCount=t.params.organizationsCount,this.state.timestamp=Date.now(),this.provider.setValue(this.state,!0);break;case Ve.is(t):this.state.orgSettings=t.params.orgSettings,this.state.timestamp=Date.now(),this.provider.setValue(this.state,!0);break;case Me.is(t):this.state.hasAnyIntegrationConnected=t.params.hasAnyIntegrationConnected,this.state.timestamp=Date.now(),this.provider.setValue(this.state,!0);break;case ze.is(t):this.state.previewEnabled=t.params.previewEnabled,this.state.previewCollapsed=t.params.previewCollapsed,this.state.timestamp=Date.now(),this.provider.setValue(this.state,!0),e.requestUpdate?.()}}))}dispose(){this.disposable.dispose()}}const ti=14;var oi=(e=>(e.Community="community",e.CommunityWithAccount="community-with-account",e.Pro="pro",e.Teams="teams",e.Enterprise="enterprise",e))(oi||{}),ii=(e=>(e[e.VerificationRequired=-1]="VerificationRequired",e[e.Community=0]="Community",e[e.ProPreview=1]="ProPreview",e[e.ProPreviewExpired=2]="ProPreviewExpired",e[e.ProTrial=3]="ProTrial",e[e.ProTrialExpired=4]="ProTrialExpired",e[e.ProTrialReactivationEligible=5]="ProTrialReactivationEligible",e[e.Paid=6]="Paid",e))(ii||{});const ni=[{key:"gitlens16",code:"GITLENS16",states:[ii.Community,ii.ProPreview,ii.ProPreviewExpired,ii.ProTrial,ii.ProTrialExpired,ii.ProTrialReactivationEligible],startsOn:new Date("2024-11-11T06:59:00.000Z").getTime(),expiresOn:new Date("2024-11-24T06:59:00.000Z").getTime(),command:{tooltip:"Save more than 55% during our GitLens 16 sale!"},locations:["account","badge","gate"],quickpick:{detail:"$(star-full) Save more than 55% during our GitLens 16 sale!"}},{key:"pro50",states:[ii.Community,ii.ProPreview,ii.ProPreviewExpired,ii.ProTrial,ii.ProTrialExpired,ii.ProTrialReactivationEligible],command:{tooltip:"Save 33% or more on your 1st seat of Pro."},locations:["account","badge","gate"],quickpick:{detail:"$(star-full) Save 33% or more on your 1st seat of Pro"}}];function ri(e,t,o){if(null!=e)for(const i of ni)if((null==o||o===i.key)&&si(i,e)){if(null==t||null==i.locations||i.locations.includes(t))return i;break}}function si(e,t){const o=Date.now();return(null==e.states||e.states.includes(t))&&(null==e.expiresOn||e.expiresOn>o)&&(null==e.startsOn||e.startsOn<o)}const ai=/(?<literal>\[.*?\])|(?<year>YYYY|YY)|(?<month>M{1,4})|(?<day>Do|DD?)|(?<weekday>d{2,4})|(?<hour>HH?|hh?)|(?<minute>mm?)|(?<second>ss?)|(?<fractionalSecond>SSS)|(?<dayPeriod>A|a)|(?<timeZoneName>ZZ?)/g,li=/(?<dateStyle>full|long|medium|short)(?:\+(?<timeStyle>full|long|medium|short))?/,ci=[["year",629856e5,31536e6,"yr"],["month",2628e6,2628e6,"mo"],["week",6048e5,6048e5,"wk"],["day",864e5,864e5,"d"],["hour",36e5,36e5,"h"],["minute",6e4,6e4,"m"],["second",1e3,1e3,"s"]];let di;const hi=new Map;let pi,ui,gi;function mi(e,t,o,i=!0){const n=`${o??""}:${t=t??void 0}`;let r=hi.get(n);if(null==r){const e=function(e){if(null==e)return{localeMatcher:"best fit",dateStyle:"full",timeStyle:"short"};const t=li.exec(e);if(null!=t?.groups){const{dateStyle:e,timeStyle:o}=t.groups;return{localeMatcher:"best fit",dateStyle:e||"full",timeStyle:o||void 0}}const o={localeMatcher:"best fit"};for(const{groups:t}of e.matchAll(ai))if(null!=t)for(const[e,i]of Object.entries(t))if(null!=i)switch(e){case"year":o.year=4===i.length?"numeric":"2-digit";break;case"month":switch(i.length){case 4:o.month="long";break;case 3:o.month="short";break;case 2:o.month="2-digit";break;case 1:o.month="numeric"}break;case"day":o.day="DD"===i?"2-digit":"numeric";break;case"weekday":switch(i.length){case 4:o.weekday="long";break;case 3:o.weekday="short";break;case 2:o.weekday="narrow"}break;case"hour":o.hour=2===i.length?"2-digit":"numeric",o.hour12="hh"===i||"h"===i;break;case"minute":o.minute=2===i.length?"2-digit":"numeric";break;case"second":o.second=2===i.length?"2-digit":"numeric";break;case"fractionalSecond":o.fractionalSecondDigits=3;break;case"dayPeriod":o.dayPeriod="narrow",o.hour12=!0,o.hourCycle="h12";break;case"timeZoneName":o.timeZoneName=2===i.length?"long":"short"}return o}(t);let a;a=null==o?pi:"system"===o?void 0:[o],r=new Intl.DateTimeFormat(a,e),i&&hi.set(n,r)}if(null==t||li.test(t))return r.format(e);function a(e){const t=`${o??""}:time:${e}`;let n=hi.get(t);if(null==n){const r={localeMatcher:"best fit",timeStyle:e};let a;a=null==o?pi:"system"===o?void 0:[o],n=new Intl.DateTimeFormat(a,r),i&&hi.set(t,n)}return n}const l=r.formatToParts(e);return t.replace(ai,((t,o,i,n,r,c,d,h,p,u,g,m,f,v,y)=>{if(null!=o)return o.substring(1,o.length-1);for(const[t,o]of Object.entries(y)){if(null==o)continue;const i=l.find((e=>e.type===t));if("Do"===o&&"day"===i?.type)return bi(Number(i.value));if("a"===o&&"dayPeriod"===i?.type){const t=a("short").formatToParts(e).find((e=>"dayPeriod"===e.type));return` ${(t??i)?.value??""}`}return i?.value??""}return""}))}const fi=["th","st","nd","rd"];function bi(e){const t=e%100;return`${e}${fi[(t-20)%10]??fi[t]??fi[0]}`}function vi(e){switch(e){case oi.CommunityWithAccount:return"GitLens Community";case oi.Pro:return"GitLens Pro";case oi.Teams:return"GitLens Teams";case oi.Enterprise:return"GitLens Enterprise";case oi.Community:default:return"GitLens"}}oi.Community,oi.CommunityWithAccount,oi.Pro,oi.Teams,oi.Enterprise;function yi(e,t){return wi(e.plan.effective.expiresOn,t)}function wi(e,t){return null!=e?function(e,t,o,i){const n=("number"==typeof t?t:t.getTime())-("number"==typeof e?e:e.getTime()),r=i??Math.floor;switch(o){case"days":return r(n/864e5);case"hours":return r(n/36e5);case"minutes":return r(n/6e4);case"seconds":return r(n/1e3);default:return n}}(Date.now(),new Date(e),t,Math.round):void 0}function _i(e){return(t=e.plan.actual.id)!==oi.Community&&t!==oi.CommunityWithAccount;var t}var ki=Object.defineProperty,xi=Object.getOwnPropertyDescriptor,$i=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?xi(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&ki(t,o,r),r};let Ci=class extends lit_element_r{constructor(){super(...arguments),this.open=!1}get headerId(){return`gl-accordion-header-${this.id??Math.random().toString(36).substring(2,9)}`}render(){return ne`
		...
		`}_handleToggle(e){const t=e.target;this.open=t.open,this.dispatchEvent(new CustomEvent("gl-toggle",{detail:{open:this.open},bubbles:!0,composed:!0}))}};Ci.shadowRootOptions={...lit_element_r.shadowRootOptions,delegatesFocus:!0},Ci.styles=p`
		:host {
			display: block;
	...
	`,$i([ye({type:Boolean})],Ci.prototype,"open",2),Ci=$i([fe("gl-accordion")],Ci);var Si=Object.defineProperty,Pi=Object.defineProperties,Ri=Object.getOwnPropertyDescriptor,Oi=Object.getOwnPropertyDescriptors,Ai=Object.getOwnPropertySymbols,Ei=Object.prototype.hasOwnProperty,Ti=Object.prototype.propertyIsEnumerable,Di=(e,t,o)=>t in e?Si(e,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):e[t]=o,Ii=(e,t)=>{for(var o in t||(t={}))Ei.call(t,o)&&Di(e,o,t[o]);if(Ai)for(var o of Ai(t))Ti.call(t,o)&&Di(e,o,t[o]);return e},Li=(e,t)=>Pi(e,Oi(t)),Fi=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?Ri(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&Si(t,o,r),r},Wi=(e,t,o)=>{if(!t.has(e))throw TypeError("Cannot "+o)},zi=new Map,Bi=new WeakMap;function Ni(e){return null!=e?e:{keyframes:[],options:{duration:0}}}function ji(e,t){return"rtl"===t.toLowerCase()?{keyframes:e.rtlKeyframes||e.keyframes,options:e.options}:e}function Mi(e,t){zi.set(e,Ni(t))}function Ui(e,t,o){const i=Bi.get(e);if(null==i?void 0:i[t])return ji(i[t],o.dir);const n=zi.get(t);return n?ji(n,o.dir):{keyframes:[],options:{duration:0}}}var Vi=p`
  :host {
    --max-width: 20rem;
    --hide-delay: 0ms;
    --show-delay: 150ms;
...
`;const qi=new Set,Hi=new Map;let Ki,Qi="ltr",Ji="en";const Yi="undefined"!=typeof MutationObserver&&"undefined"!=typeof document&&void 0!==document.documentElement;if(Yi){const e=new MutationObserver(Xi);Qi=document.documentElement.dir||"ltr",Ji=document.documentElement.lang||navigator.language,e.observe(document.documentElement,{attributes:!0,attributeFilter:["dir","lang"]})}function Zi(...e){e.map((e=>{const t=e.$code.toLowerCase();Hi.has(t)?Hi.set(t,Object.assign(Object.assign({},Hi.get(t)),e)):Hi.set(t,e),Ki||(Ki=e)})),Xi()}function Xi(){Yi&&(Qi=document.documentElement.dir||"ltr",Ji=document.documentElement.lang||navigator.language),[...qi.keys()].map((e=>{"function"==typeof e.requestUpdate&&e.requestUpdate()}))}class LocalizeController{constructor(e){this.host=e,this.host.addController(this)}hostConnected(){qi.add(this.host)}hostDisconnected(){qi.delete(this.host)}dir(){return`${this.host.dir||Qi}`.toLowerCase()}lang(){return`${this.host.lang||Ji}`.toLowerCase()}getTranslationData(e){var t,o;const i=new Intl.Locale(e.replace(/_/g,"-")),n=null==i?void 0:i.language.toLowerCase(),r=null!==(o=null===(t=null==i?void 0:i.region)||void 0===t?void 0:t.toLowerCase())&&void 0!==o?o:"";return{locale:i,language:n,region:r,primary:Hi.get(`${n}-${r}`),secondary:Hi.get(n)}}exists(e,t){var o;const{primary:i,secondary:n}=this.getTranslationData(null!==(o=t.lang)&&void 0!==o?o:this.lang());return t=Object.assign({includeFallback:!1},t),!!(i&&i[e]||n&&n[e]||t.includeFallback&&Ki&&Ki[e])}term(e,...t){const{primary:o,secondary:i}=this.getTranslationData(this.lang());let n;if(o&&o[e])n=o[e];else if(i&&i[e])n=i[e];else{if(!Ki||!Ki[e])return String(e);n=Ki[e]}return"function"==typeof n?n(...t):n}date(e,t){return e=new Date(e),new Intl.DateTimeFormat(this.lang(),t).format(e)}number(e,t){return e=Number(e),isNaN(e)?"":new Intl.NumberFormat(this.lang(),t).format(e)}relativeTime(e,t,o){return new Intl.RelativeTimeFormat(this.lang(),o).format(e,t)}}var en={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(e,t)=>`Go to slide ${e} of ${t}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:e=>0===e?"No options selected":1===e?"1 option selected":`${e} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:e=>`Slide ${e}`,toggleColorFormat:"Toggle color format"};Zi(en);var tn=en,on=class extends LocalizeController{};Zi(tn);var nn,rn=p`
  :host {
    box-sizing: border-box;
  }
...
`,sn=class extends lit_element_r{constructor(){super(),((e,t,o)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,o)})(this,nn,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach((([e,t])=>{this.constructor.define(e,t)}))}emit(e,t){const o=new CustomEvent(e,Ii({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(o),o}static define(e,t=this,o={}){const i=customElements.get(e);if(!i){try{customElements.define(e,t,o)}catch(i){customElements.define(e,class extends t{},o)}return}let n=" (unknown version)",r=n;"version"in t&&t.version&&(n=" v"+t.version),"version"in i&&i.version&&(r=" v"+i.version)}attributeChangedCallback(e,t,o){var i,n,r;Wi(i=this,n=nn,"read from private field"),(r?r.call(i):n.get(i))||(this.constructor.elementProperties.forEach(((e,t)=>{e.reflect&&null!=this[t]&&this.initialReflectedProperties.set(t,this[t])})),((e,t,o,i)=>{Wi(e,t,"write to private field"),i?i.call(e,o):t.set(e,o)})(this,nn,!0)),super.attributeChangedCallback(e,t,o)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach(((t,o)=>{e.has(o)&&null==this[o]&&(this[o]=t)}))}};nn=new WeakMap,sn.version="2.18.0",sn.dependencies={},Fi([ye()],sn.prototype,"dir",2),Fi([ye()],sn.prototype,"lang",2);const an=Math.min,ln=Math.max,cn=Math.round,dn=Math.floor,hn=e=>({x:e,y:e}),pn={left:"right",right:"left",bottom:"top",top:"bottom"},un={start:"end",end:"start"};function gn(e,t,o){return ln(e,an(t,o))}function mn(e,t){return"function"==typeof e?e(t):e}function fn(e){return e.split("-")[0]}function bn(e){return e.split("-")[1]}function vn(e){return"x"===e?"y":"x"}function yn(e){return"y"===e?"height":"width"}function wn(e){return["top","bottom"].includes(fn(e))?"y":"x"}function _n(e){return vn(wn(e))}function kn(e){return e.replace(/start|end/g,(e=>un[e]))}function xn(e){return e.replace(/left|right|bottom|top/g,(e=>pn[e]))}function $n(e){return"number"!=typeof e?function(e){return{top:0,right:0,bottom:0,left:0,...e}}(e):{top:e,right:e,bottom:e,left:e}}function Cn(e){const{x:t,y:o,width:i,height:n}=e;return{width:i,height:n,top:o,left:t,right:t+i,bottom:o+n,x:t,y:o}}function Sn(e,t,o){let{reference:i,floating:n}=e;const r=wn(t),a=_n(t),l=yn(a),c=fn(t),d="y"===r,h=i.x+i.width/2-n.width/2,p=i.y+i.height/2-n.height/2,u=i[l]/2-n[l]/2;let g;switch(c){case"top":g={x:h,y:i.y-n.height};break;case"bottom":g={x:h,y:i.y+i.height};break;case"right":g={x:i.x+i.width,y:p};break;case"left":g={x:i.x-n.width,y:p};break;default:g={x:i.x,y:i.y}}switch(bn(t)){case"start":g[a]-=u*(o&&d?-1:1);break;case"end":g[a]+=u*(o&&d?-1:1)}return g}async function Pn(e,t){var o;void 0===t&&(t={});const{x:i,y:n,platform:r,rects:a,elements:l,strategy:c}=e,{boundary:d="clippingAncestors",rootBoundary:h="viewport",elementContext:p="floating",altBoundary:u=!1,padding:g=0}=mn(t,e),m=$n(g),f=l[u?"floating"===p?"reference":"floating":p],v=Cn(await r.getClippingRect({element:null==(o=await(null==r.isElement?void 0:r.isElement(f)))||o?f:f.contextElement||await(null==r.getDocumentElement?void 0:r.getDocumentElement(l.floating)),boundary:d,rootBoundary:h,strategy:c})),y="floating"===p?{x:i,y:n,width:a.floating.width,height:a.floating.height}:a.reference,w=await(null==r.getOffsetParent?void 0:r.getOffsetParent(l.floating)),_=await(null==r.isElement?void 0:r.isElement(w))&&await(null==r.getScale?void 0:r.getScale(w))||{x:1,y:1},x=Cn(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:l,rect:y,offsetParent:w,strategy:c}):y);return{top:(v.top-x.top+m.top)/_.y,bottom:(x.bottom-v.bottom+m.bottom)/_.y,left:(v.left-x.left+m.left)/_.x,right:(x.right-v.right+m.right)/_.x}}function Rn(){return"undefined"!=typeof window}function On(e){return Tn(e)?(e.nodeName||"").toLowerCase():"#document"}function An(e){var t;return(null==e||null==(t=e.ownerDocument)?void 0:t.defaultView)||window}function En(e){var t;return null==(t=(Tn(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function Tn(e){return!!Rn()&&(e instanceof Node||e instanceof An(e).Node)}function Dn(e){return!!Rn()&&(e instanceof Element||e instanceof An(e).Element)}function In(e){return!!Rn()&&(e instanceof HTMLElement||e instanceof An(e).HTMLElement)}function Ln(e){return!(!Rn()||"undefined"==typeof ShadowRoot)&&(e instanceof ShadowRoot||e instanceof An(e).ShadowRoot)}function Fn(e){const{overflow:t,overflowX:o,overflowY:i,display:n}=Mn(e);return/auto|scroll|overlay|hidden|clip/.test(t+i+o)&&!["inline","contents"].includes(n)}function Wn(e){return["table","td","th"].includes(On(e))}function zn(e){return[":popover-open",":modal"].some((t=>{try{return e.matches(t)}catch(e){return!1}}))}function Bn(e){const t=Nn(),o=Dn(e)?Mn(e):e;return"none"!==o.transform||"none"!==o.perspective||!!o.containerType&&"normal"!==o.containerType||!t&&!!o.backdropFilter&&"none"!==o.backdropFilter||!t&&!!o.filter&&"none"!==o.filter||["transform","perspective","filter"].some((e=>(o.willChange||"").includes(e)))||["paint","layout","strict","content"].some((e=>(o.contain||"").includes(e)))}function Nn(){return!("undefined"==typeof CSS||!CSS.supports)&&CSS.supports("-webkit-backdrop-filter","none")}function jn(e){return["html","body","#document"].includes(On(e))}function Mn(e){return An(e).getComputedStyle(e)}function Un(e){return Dn(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function Vn(e){if("html"===On(e))return e;const t=e.assignedSlot||e.parentNode||Ln(e)&&e.host||En(e);return Ln(t)?t.host:t}function Gn(e){const t=Vn(e);return jn(t)?e.ownerDocument?e.ownerDocument.body:e.body:In(t)&&Fn(t)?t:Gn(t)}function qn(e,t,o){var i;void 0===t&&(t=[]),void 0===o&&(o=!0);const n=Gn(e),r=n===(null==(i=e.ownerDocument)?void 0:i.body),a=An(n);if(r){const e=Hn(a);return t.concat(a,a.visualViewport||[],Fn(n)?n:[],e&&o?qn(e):[])}return t.concat(n,qn(n,[],o))}function Hn(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function Kn(e){const t=Mn(e);let o=parseFloat(t.width)||0,i=parseFloat(t.height)||0;const n=In(e),r=n?e.offsetWidth:o,a=n?e.offsetHeight:i,l=cn(o)!==r||cn(i)!==a;return l&&(o=r,i=a),{width:o,height:i,$:l}}function Qn(e){return Dn(e)?e:e.contextElement}function Jn(e){const t=Qn(e);if(!In(t))return hn(1);const o=t.getBoundingClientRect(),{width:i,height:n,$:r}=Kn(t);let a=(r?cn(o.width):o.width)/i,l=(r?cn(o.height):o.height)/n;return a&&Number.isFinite(a)||(a=1),l&&Number.isFinite(l)||(l=1),{x:a,y:l}}const Yn=hn(0);function Zn(e){const t=An(e);return Nn()&&t.visualViewport?{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}:Yn}function Xn(e,t,o,i){void 0===t&&(t=!1),void 0===o&&(o=!1);const n=e.getBoundingClientRect(),r=Qn(e);let a=hn(1);t&&(i?Dn(i)&&(a=Jn(i)):a=Jn(e));const l=function(e,t,o){return void 0===t&&(t=!1),!(!o||t&&o!==An(e))&&t}(r,o,i)?Zn(r):hn(0);let c=(n.left+l.x)/a.x,d=(n.top+l.y)/a.y,h=n.width/a.x,p=n.height/a.y;if(r){const e=An(r),t=i&&Dn(i)?An(i):i;let o=e,n=Hn(o);for(;n&&i&&t!==o;){const e=Jn(n),t=n.getBoundingClientRect(),i=Mn(n),r=t.left+(n.clientLeft+parseFloat(i.paddingLeft))*e.x,a=t.top+(n.clientTop+parseFloat(i.paddingTop))*e.y;c*=e.x,d*=e.y,h*=e.x,p*=e.y,c+=r,d+=a,o=An(n),n=Hn(o)}}return Cn({width:h,height:p,x:c,y:d})}function er(e,t){const o=Un(e).scrollLeft;return t?t.left+o:Xn(En(e)).left+o}function tr(e,t,o){void 0===o&&(o=!1);const i=e.getBoundingClientRect();return{x:i.left+t.scrollLeft-(o?0:er(e,i)),y:i.top+t.scrollTop}}function or(e,t,o){let i;if("viewport"===t)i=function(e,t){const o=An(e),i=En(e),n=o.visualViewport;let r=i.clientWidth,a=i.clientHeight,l=0,c=0;if(n){r=n.width,a=n.height;const e=Nn();(!e||e&&"fixed"===t)&&(l=n.offsetLeft,c=n.offsetTop)}return{width:r,height:a,x:l,y:c}}(e,o);else if("document"===t)i=function(e){const t=En(e),o=Un(e),i=e.ownerDocument.body,n=ln(t.scrollWidth,t.clientWidth,i.scrollWidth,i.clientWidth),r=ln(t.scrollHeight,t.clientHeight,i.scrollHeight,i.clientHeight);let a=-o.scrollLeft+er(e);const l=-o.scrollTop;return"rtl"===Mn(i).direction&&(a+=ln(t.clientWidth,i.clientWidth)-n),{width:n,height:r,x:a,y:l}}(En(e));else if(Dn(t))i=function(e,t){const o=Xn(e,!0,"fixed"===t),i=o.top+e.clientTop,n=o.left+e.clientLeft,r=In(e)?Jn(e):hn(1);return{width:e.clientWidth*r.x,height:e.clientHeight*r.y,x:n*r.x,y:i*r.y}}(t,o);else{const o=Zn(e);i={x:t.x-o.x,y:t.y-o.y,width:t.width,height:t.height}}return Cn(i)}function ir(e,t){const o=Vn(e);return!(o===t||!Dn(o)||jn(o))&&("fixed"===Mn(o).position||ir(o,t))}function nr(e,t,o){const i=In(t),n=En(t),r="fixed"===o,a=Xn(e,!0,r,t);let l={scrollLeft:0,scrollTop:0};const c=hn(0);if(i||!i&&!r)if(("body"!==On(t)||Fn(n))&&(l=Un(t)),i){const e=Xn(t,!0,r,t);c.x=e.x+t.clientLeft,c.y=e.y+t.clientTop}else n&&(c.x=er(n));const d=!n||i||r?hn(0):tr(n,l);return{x:a.left+l.scrollLeft-c.x-d.x,y:a.top+l.scrollTop-c.y-d.y,width:a.width,height:a.height}}function rr(e){return"static"===Mn(e).position}function sr(e,t){if(!In(e)||"fixed"===Mn(e).position)return null;if(t)return t(e);let o=e.offsetParent;return En(e)===o&&(o=o.ownerDocument.body),o}function ar(e,t){const o=An(e);if(zn(e))return o;if(!In(e)){let t=Vn(e);for(;t&&!jn(t);){if(Dn(t)&&!rr(t))return t;t=Vn(t)}return o}let i=sr(e,t);for(;i&&Wn(i)&&rr(i);)i=sr(i,t);return i&&jn(i)&&rr(i)&&!Bn(i)?o:i||function(e){let t=Vn(e);for(;In(t)&&!jn(t);){if(Bn(t))return t;if(zn(t))return null;t=Vn(t)}return null}(e)||o}const lr={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{elements:t,rect:o,offsetParent:i,strategy:n}=e;const r="fixed"===n,a=En(i),l=!!t&&zn(t.floating);if(i===a||l&&r)return o;let c={scrollLeft:0,scrollTop:0},d=hn(1);const h=hn(0),p=In(i);if((p||!p&&!r)&&(("body"!==On(i)||Fn(a))&&(c=Un(i)),In(i))){const e=Xn(i);d=Jn(i),h.x=e.x+i.clientLeft,h.y=e.y+i.clientTop}const u=!a||p||r?hn(0):tr(a,c,!0);return{width:o.width*d.x,height:o.height*d.y,x:o.x*d.x-c.scrollLeft*d.x+h.x+u.x,y:o.y*d.y-c.scrollTop*d.y+h.y+u.y}},getDocumentElement:En,getClippingRect:function(e){let{element:t,boundary:o,rootBoundary:i,strategy:n}=e;const r=[..."clippingAncestors"===o?zn(t)?[]:function(e,t){const o=t.get(e);if(o)return o;let i=qn(e,[],!1).filter((e=>Dn(e)&&"body"!==On(e))),n=null;const r="fixed"===Mn(e).position;let a=r?Vn(e):e;for(;Dn(a)&&!jn(a);){const t=Mn(a),o=Bn(a);o||"fixed"!==t.position||(n=null),(r?!o&&!n:!o&&"static"===t.position&&n&&["absolute","fixed"].includes(n.position)||Fn(a)&&!o&&ir(e,a))?i=i.filter((e=>e!==a)):n=t,a=Vn(a)}return t.set(e,i),i}(t,this._c):[].concat(o),i],a=r[0],l=r.reduce(((e,o)=>{const i=or(t,o,n);return e.top=ln(i.top,e.top),e.right=an(i.right,e.right),e.bottom=an(i.bottom,e.bottom),e.left=ln(i.left,e.left),e}),or(t,a,n));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}},getOffsetParent:ar,getElementRects:async function(e){const t=this.getOffsetParent||ar,o=this.getDimensions,i=await o(e.floating);return{reference:nr(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:i.width,height:i.height}}},getClientRects:function(e){return Array.from(e.getClientRects())},getDimensions:function(e){const{width:t,height:o}=Kn(e);return{width:t,height:o}},getScale:Jn,isElement:Dn,isRTL:function(e){return"rtl"===Mn(e).direction}};function cr(e,t,o,i){void 0===i&&(i={});const{ancestorScroll:n=!0,ancestorResize:r=!0,elementResize:a="function"==typeof ResizeObserver,layoutShift:l="function"==typeof IntersectionObserver,animationFrame:c=!1}=i,d=Qn(e),h=n||r?[...d?qn(d):[],...qn(t)]:[];h.forEach((e=>{n&&e.addEventListener("scroll",o,{passive:!0}),r&&e.addEventListener("resize",o)}));const p=d&&l?function(e,t){let o,i=null;const n=En(e);function r(){var e;clearTimeout(o),null==(e=i)||e.disconnect(),i=null}return function a(l,c){void 0===l&&(l=!1),void 0===c&&(c=1),r();const{left:d,top:h,width:p,height:u}=e.getBoundingClientRect();if(l||t(),!p||!u)return;const g={rootMargin:-dn(h)+"px "+-dn(n.clientWidth-(d+p))+"px "+-dn(n.clientHeight-(h+u))+"px "+-dn(d)+"px",threshold:ln(0,an(1,c))||1};let m=!0;function f(e){const t=e[0].intersectionRatio;if(t!==c){if(!m)return a();t?a(!1,t):o=setTimeout((()=>{a(!1,1e-7)}),1e3)}m=!1}try{i=new IntersectionObserver(f,{...g,root:n.ownerDocument})}catch(e){i=new IntersectionObserver(f,g)}i.observe(e)}(!0),r}(d,o):null;let u,g=-1,m=null;a&&(m=new ResizeObserver((e=>{let[i]=e;i&&i.target===d&&m&&(m.unobserve(t),cancelAnimationFrame(g),g=requestAnimationFrame((()=>{var e;null==(e=m)||e.observe(t)}))),o()})),d&&!c&&m.observe(d),m.observe(t));let f=c?Xn(e):null;return c&&function t(){const i=Xn(e);!f||i.x===f.x&&i.y===f.y&&i.width===f.width&&i.height===f.height||o();f=i,u=requestAnimationFrame(t)}(),o(),()=>{var e;h.forEach((e=>{n&&e.removeEventListener("scroll",o),r&&e.removeEventListener("resize",o)})),null==p||p(),null==(e=m)||e.disconnect(),m=null,c&&cancelAnimationFrame(u)}}const dr=function(e){return void 0===e&&(e=0),{name:"offset",options:e,async fn(t){var o,i;const{x:n,y:r,placement:a,middlewareData:l}=t,c=await async function(e,t){const{placement:o,platform:i,elements:n}=e,r=await(null==i.isRTL?void 0:i.isRTL(n.floating)),a=fn(o),l=bn(o),c="y"===wn(o),d=["left","top"].includes(a)?-1:1,h=r&&c?-1:1,p=mn(t,e);let{mainAxis:u,crossAxis:g,alignmentAxis:m}="number"==typeof p?{mainAxis:p,crossAxis:0,alignmentAxis:null}:{mainAxis:p.mainAxis||0,crossAxis:p.crossAxis||0,alignmentAxis:p.alignmentAxis};return l&&"number"==typeof m&&(g="end"===l?-1*m:m),c?{x:g*h,y:u*d}:{x:u*d,y:g*h}}(t,e);return a===(null==(o=l.offset)?void 0:o.placement)&&null!=(i=l.arrow)&&i.alignmentOffset?{}:{x:n+c.x,y:r+c.y,data:{...c,placement:a}}}}},hr=function(e){return void 0===e&&(e={}),{name:"shift",options:e,async fn(t){const{x:o,y:i,placement:n}=t,{mainAxis:r=!0,crossAxis:a=!1,limiter:l={fn:e=>{let{x:t,y:o}=e;return{x:t,y:o}}},...c}=mn(e,t),d={x:o,y:i},h=await Pn(t,c),p=wn(fn(n)),u=vn(p);let g=d[u],m=d[p];if(r){const e="y"===u?"bottom":"right";g=gn(g+h["y"===u?"top":"left"],g,g-h[e])}if(a){const e="y"===p?"bottom":"right";m=gn(m+h["y"===p?"top":"left"],m,m-h[e])}const f=l.fn({...t,[u]:g,[p]:m});return{...f,data:{x:f.x-o,y:f.y-i,enabled:{[u]:r,[p]:a}}}}}},pr=function(e){return void 0===e&&(e={}),{name:"flip",options:e,async fn(t){var o,i;const{placement:n,middlewareData:r,rects:a,initialPlacement:l,platform:c,elements:d}=t,{mainAxis:h=!0,crossAxis:p=!0,fallbackPlacements:u,fallbackStrategy:g="bestFit",fallbackAxisSideDirection:m="none",flipAlignment:f=!0,...v}=mn(e,t);if(null!=(o=r.arrow)&&o.alignmentOffset)return{};const y=fn(n),w=wn(l),_=fn(l)===l,x=await(null==c.isRTL?void 0:c.isRTL(d.floating)),$=u||(_||!f?[xn(l)]:function(e){const t=xn(e);return[kn(e),t,kn(t)]}(l)),C="none"!==m;!u&&C&&$.push(...function(e,t,o,i){const n=bn(e);let r=function(e,t,o){const i=["left","right"],n=["right","left"],r=["top","bottom"],a=["bottom","top"];switch(e){case"top":case"bottom":return o?t?n:i:t?i:n;case"left":case"right":return t?r:a;default:return[]}}(fn(e),"start"===o,i);return n&&(r=r.map((e=>e+"-"+n)),t&&(r=r.concat(r.map(kn)))),r}(l,f,m,x));const S=[l,...$],P=await Pn(t,v),O=[];let A=(null==(i=r.flip)?void 0:i.overflows)||[];if(h&&O.push(P[y]),p){const e=function(e,t,o){void 0===o&&(o=!1);const i=bn(e),n=_n(e),r=yn(n);let a="x"===n?i===(o?"end":"start")?"right":"left":"start"===i?"bottom":"top";return t.reference[r]>t.floating[r]&&(a=xn(a)),[a,xn(a)]}(n,a,x);O.push(P[e[0]],P[e[1]])}if(A=[...A,{placement:n,overflows:O}],!O.every((e=>e<=0))){var E,T;const e=((null==(E=r.flip)?void 0:E.index)||0)+1,t=S[e];if(t)return{data:{index:e,overflows:A},reset:{placement:t}};let o=null==(T=A.filter((e=>e.overflows[0]<=0)).sort(((e,t)=>e.overflows[1]-t.overflows[1]))[0])?void 0:T.placement;if(!o)switch(g){case"bestFit":{var D;const e=null==(D=A.filter((e=>{if(C){const t=wn(e.placement);return t===w||"y"===t}return!0})).map((e=>[e.placement,e.overflows.filter((e=>e>0)).reduce(((e,t)=>e+t),0)])).sort(((e,t)=>e[1]-t[1]))[0])?void 0:D[0];e&&(o=e);break}case"initialPlacement":o=l}if(n!==o)return{reset:{placement:o}}}return{}}}},ur=function(e){return void 0===e&&(e={}),{name:"size",options:e,async fn(t){var o,i;const{placement:n,rects:r,platform:a,elements:l}=t,{apply:c=()=>{},...d}=mn(e,t),h=await Pn(t,d),p=fn(n),u=bn(n),g="y"===wn(n),{width:m,height:f}=r.floating;let v,y;"top"===p||"bottom"===p?(v=p,y=u===(await(null==a.isRTL?void 0:a.isRTL(l.floating))?"start":"end")?"left":"right"):(y=p,v="end"===u?"top":"bottom");const w=f-h.top-h.bottom,_=m-h.left-h.right,x=an(f-h[v],w),$=an(m-h[y],_),C=!t.middlewareData.shift;let S=x,P=$;if(null!=(o=t.middlewareData.shift)&&o.enabled.x&&(P=_),null!=(i=t.middlewareData.shift)&&i.enabled.y&&(S=w),C&&!u){const e=ln(h.left,0),t=ln(h.right,0),o=ln(h.top,0),i=ln(h.bottom,0);g?P=m-2*(0!==e||0!==t?e+t:ln(h.left,h.right)):S=f-2*(0!==o||0!==i?o+i:ln(h.top,h.bottom))}await c({...t,availableWidth:P,availableHeight:S});const O=await a.getDimensions(l.floating);return m!==O.width||f!==O.height?{reset:{rects:!0}}:{}}}},gr=e=>({name:"arrow",options:e,async fn(t){const{x:o,y:i,placement:n,rects:r,platform:a,elements:l,middlewareData:c}=t,{element:d,padding:h=0}=mn(e,t)||{};if(null==d)return{};const p=$n(h),u={x:o,y:i},g=_n(n),m=yn(g),f=await a.getDimensions(d),v="y"===g,y=v?"top":"left",w=v?"bottom":"right",_=v?"clientHeight":"clientWidth",x=r.reference[m]+r.reference[g]-u[g]-r.floating[m],$=u[g]-r.reference[g],C=await(null==a.getOffsetParent?void 0:a.getOffsetParent(d));let S=C?C[_]:0;S&&await(null==a.isElement?void 0:a.isElement(C))||(S=l.floating[_]||r.floating[m]);const P=x/2-$/2,O=S/2-f[m]/2-1,A=an(p[y],O),E=an(p[w],O),T=A,D=S-f[m]-E,F=S/2-f[m]/2+P,W=gn(T,F,D),B=!c.arrow&&null!=bn(n)&&F!==W&&r.reference[m]/2-(F<T?A:E)-f[m]/2<0,j=B?F<T?F-T:F-D:0;return{[g]:u[g]+j,data:{[g]:W,centerOffset:F-W-j,...B&&{alignmentOffset:j}},reset:B}}}),mr=(e,t,o)=>{const i=new Map,n={platform:lr,...o},r={...n.platform,_c:i};return(async(e,t,o)=>{const{placement:i="bottom",strategy:n="absolute",middleware:r=[],platform:a}=o,l=r.filter(Boolean),c=await(null==a.isRTL?void 0:a.isRTL(t));let d=await a.getElementRects({reference:e,floating:t,strategy:n}),{x:h,y:p}=Sn(d,i,c),u=i,g={},m=0;for(let o=0;o<l.length;o++){const{name:r,fn:f}=l[o],{x:v,y,data:w,reset:_}=await f({x:h,y:p,initialPlacement:i,placement:u,strategy:n,middlewareData:g,rects:d,platform:a,elements:{reference:e,floating:t}});h=null!=v?v:h,p=null!=y?y:p,g={...g,[r]:{...g[r],...w}},_&&m<=50&&(m++,"object"==typeof _&&(_.placement&&(u=_.placement),_.rects&&(d=!0===_.rects?await a.getElementRects({reference:e,floating:t,strategy:n}):_.rects),({x:h,y:p}=Sn(d,u,c))),o=-1)}return{x:h,y:p,placement:u,strategy:n,middlewareData:g}})(e,t,{...n,platform:r})},fr=Dt(class extends directive_i{constructor(e){if(super(e),e.type!==Et||"class"!==e.name||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){if(void 0===this.st){this.st=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter((e=>""!==e))));for(const e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}const o=e.element.classList;for(const e of this.st)e in t||(o.remove(e),this.st.delete(e));for(const e in t){const i=!!t[e];i===this.st.has(e)||this.nt?.has(e)||(i?(o.add(e),this.st.add(e)):(o.remove(e),this.st.delete(e)))}return se}});function br(e){return yr(e)}function vr(e){return e.assignedSlot?e.assignedSlot:e.parentNode instanceof ShadowRoot?e.parentNode.host:e.parentNode}function yr(e){for(let t=e;t;t=vr(t))if(t instanceof Element&&"none"===getComputedStyle(t).display)return null;for(let t=vr(e);t;t=vr(t)){if(!(t instanceof Element))continue;const e=getComputedStyle(t);if("contents"!==e.display){if("static"!==e.position||"none"!==e.filter)return t;if("BODY"===t.tagName)return t}}return null}var wr=class extends sn{constructor(){super(...arguments),this.localize=new on(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect();let o=0,i=0,n=0,r=0,a=0,l=0,c=0,d=0;this.placement.includes("top")||this.placement.includes("bottom")?e.top<t.top?(o=e.left,i=e.bottom,n=e.right,r=e.bottom,a=t.left,l=t.top,c=t.right,d=t.top):(o=t.left,i=t.bottom,n=t.right,r=t.bottom,a=e.left,l=e.top,c=e.right,d=e.top):e.left<t.left?(o=e.right,i=e.top,n=t.left,r=t.top,a=e.right,l=e.bottom,c=t.left,d=t.bottom):(o=t.right,i=t.top,n=e.left,r=e.top,a=t.right,l=t.bottom,c=e.left,d=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${o}px`),this.style.setProperty("--hover-bridge-top-left-y",`${i}px`),this.style.setProperty("--hover-bridge-top-right-x",`${n}px`),this.style.setProperty("--hover-bridge-top-right-y",`${r}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${a}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${l}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${c}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${d}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&"string"==typeof this.anchor){const e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||function(e){return null!==e&&"object"==typeof e&&"getBoundingClientRect"in e&&(!("contextElement"in e)||e instanceof Element)}(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){this.anchorEl&&(this.cleanup=cr(this.anchorEl,this.popup,(()=>{this.reposition()})))}async stop(){return new Promise((e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame((()=>e()))):e()}))}reposition(){if(!this.active||!this.anchorEl)return;const e=[dr({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(ur({apply:({rects:e})=>{const t="width"===this.sync||"both"===this.sync,o="height"===this.sync||"both"===this.sync;this.popup.style.width=t?`${e.reference.width}px`:"",this.popup.style.height=o?`${e.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&e.push(pr({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:"best-fit"===this.flipFallbackStrategy?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&e.push(hr({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(ur({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:e,availableHeight:t})=>{"vertical"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-height",`${t}px`):this.style.removeProperty("--auto-size-available-height"),"horizontal"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-width",`${e}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&e.push(gr({element:this.arrowEl,padding:this.arrowPadding}));const t="absolute"===this.strategy?e=>lr.getOffsetParent(e,br):lr.getOffsetParent;mr(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:this.strategy,platform:Li(Ii({},lr),{getOffsetParent:t})}).then((({x:e,y:t,middlewareData:o,placement:i})=>{const n="rtl"===this.localize.dir(),r={top:"bottom",right:"left",bottom:"top",left:"right"}[i.split("-")[0]];if(this.setAttribute("data-current-placement",i),Object.assign(this.popup.style,{left:`${e}px`,top:`${t}px`}),this.arrow){const e=o.arrow.x,t=o.arrow.y;let i="",a="",l="",c="";if("start"===this.arrowPlacement){const o="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";i="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",a=n?o:"",c=n?"":o}else if("end"===this.arrowPlacement){const o="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";a=n?"":o,c=n?o:"",l="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else"center"===this.arrowPlacement?(c="number"==typeof e?"calc(50% - var(--arrow-size-diagonal))":"",i="number"==typeof t?"calc(50% - var(--arrow-size-diagonal))":""):(c="number"==typeof e?`${e}px`:"",i="number"==typeof t?`${t}px`:"");Object.assign(this.arrowEl.style,{top:i,right:a,bottom:l,left:c,[r]:"calc(var(--arrow-size-diagonal) * -1)"})}})),requestAnimationFrame((()=>this.updateHoverBridge())),this.emit("sl-reposition")}render(){return ne`
      <slot name="anchor" @slotchange=${this.handleAnchorChange}></slot>

      <span
        part="hover-bridge"
        class=${fr({"popup-hover-bridge":!0,"popup-hover-bridge--visible":this.hoverBridge&&this.active})}
      ></span>

      <div
        part="popup"
        class=${fr({popup:!0,"popup--active":this.active,"popup--fixed":"fixed"===this.strategy,"popup--has-arrow":this.arrow})}
      >
        <slot></slot>
        ${this.arrow?ne`<div part="arrow" class="popup__arrow" role="presentation"></div>`:""}
      </div>
    `}};function _r(e,t){return new Promise((o=>{e.addEventListener(t,(function i(n){n.target===e&&(e.removeEventListener(t,i),o())}))}))}function kr(e,t,o){return new Promise((i=>{if((null==o?void 0:o.duration)===1/0)throw new Error("Promise-based animations must be finite.");const n=e.animate(t,Li(Ii({},o),{duration:$r()?0:o.duration}));n.addEventListener("cancel",i,{once:!0}),n.addEventListener("finish",i,{once:!0})}))}function xr(e){return(e=e.toString().toLowerCase()).indexOf("ms")>-1?parseFloat(e):e.indexOf("s")>-1?1e3*parseFloat(e):parseFloat(e)}function $r(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Cr(e){return Promise.all(e.getAnimations().map((e=>new Promise((t=>{e.cancel(),requestAnimationFrame(t)})))))}function Sr(e,t){const o=Ii({waitUntilFirstUpdate:!1},t);return(t,i)=>{const{update:n}=t,r=Array.isArray(e)?e:[e];t.update=function(e){r.forEach((t=>{const n=t;if(e.has(n)){const t=e.get(n),r=this[n];t!==r&&(o.waitUntilFirstUpdate&&!this.hasUpdated||this[i](t,r))}})),n.call(this,e)}}}wr.styles=[rn,Gi],Fi([ke(".popup")],wr.prototype,"popup",2),Fi([ke(".popup__arrow")],wr.prototype,"arrowEl",2),Fi([ye()],wr.prototype,"anchor",2),Fi([ye({type:Boolean,reflect:!0})],wr.prototype,"active",2),Fi([ye({reflect:!0})],wr.prototype,"placement",2),Fi([ye({reflect:!0})],wr.prototype,"strategy",2),Fi([ye({type:Number})],wr.prototype,"distance",2),Fi([ye({type:Number})],wr.prototype,"skidding",2),Fi([ye({type:Boolean})],wr.prototype,"arrow",2),Fi([ye({attribute:"arrow-placement"})],wr.prototype,"arrowPlacement",2),Fi([ye({attribute:"arrow-padding",type:Number})],wr.prototype,"arrowPadding",2),Fi([ye({type:Boolean})],wr.prototype,"flip",2),Fi([ye({attribute:"flip-fallback-placements",converter:{fromAttribute:e=>e.split(" ").map((e=>e.trim())).filter((e=>""!==e)),toAttribute:e=>e.join(" ")}})],wr.prototype,"flipFallbackPlacements",2),Fi([ye({attribute:"flip-fallback-strategy"})],wr.prototype,"flipFallbackStrategy",2),Fi([ye({type:Object})],wr.prototype,"flipBoundary",2),Fi([ye({attribute:"flip-padding",type:Number})],wr.prototype,"flipPadding",2),Fi([ye({type:Boolean})],wr.prototype,"shift",2),Fi([ye({type:Object})],wr.prototype,"shiftBoundary",2),Fi([ye({attribute:"shift-padding",type:Number})],wr.prototype,"shiftPadding",2),Fi([ye({attribute:"auto-size"})],wr.prototype,"autoSize",2),Fi([ye()],wr.prototype,"sync",2),Fi([ye({type:Object})],wr.prototype,"autoSizeBoundary",2),Fi([ye({attribute:"auto-size-padding",type:Number})],wr.prototype,"autoSizePadding",2),Fi([ye({attribute:"hover-bridge",type:Boolean})],wr.prototype,"hoverBridge",2);var Pr=class extends sn{constructor(){super(),this.localize=new on(this),this.content="",this.placement="top",this.disabled=!1,this.distance=8,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=e=>{"Escape"===e.key&&(e.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){const e=xr(getComputedStyle(this).getPropertyValue("--show-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout((()=>this.show()),e)}},this.handleMouseOut=()=>{if(this.hasTrigger("hover")){const e=xr(getComputedStyle(this).getPropertyValue("--hide-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout((()=>this.hide()),e)}},this.addEventListener("blur",this.handleBlur,!0),this.addEventListener("focus",this.handleFocus,!0),this.addEventListener("click",this.handleClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}disconnectedCallback(){var e;super.disconnectedCallback(),null==(e=this.closeWatcher)||e.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(e){return this.trigger.split(" ").includes(e)}async handleOpenChange(){var e,t;if(this.open){if(this.disabled)return;this.emit("sl-show"),"CloseWatcher"in window?(null==(e=this.closeWatcher)||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),await Cr(this.body),this.body.hidden=!1,this.popup.active=!0;const{keyframes:t,options:o}=Ui(this,"tooltip.show",{dir:this.localize.dir()});await kr(this.popup.popup,t,o),this.popup.reposition(),this.emit("sl-after-show")}else{this.emit("sl-hide"),null==(t=this.closeWatcher)||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),await Cr(this.body);const{keyframes:e,options:o}=Ui(this,"tooltip.hide",{dir:this.localize.dir()});await kr(this.popup.popup,e,o),this.popup.active=!1,this.body.hidden=!0,this.emit("sl-after-hide")}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,_r(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,_r(this,"sl-after-hide")}render(){return ne`
      <sl-popup
        part="base"
        exportparts="
          popup:base__popup,
          arrow:base__arrow
        "
        class=${fr({tooltip:!0,"tooltip--open":this.open})}
    ...
    `}};Pr.styles=[rn,Vi],Pr.dependencies={"sl-popup":wr},Fi([ke("slot:not([name])")],Pr.prototype,"defaultSlot",2),Fi([ke(".tooltip__body")],Pr.prototype,"body",2),Fi([ke("sl-popup")],Pr.prototype,"popup",2),Fi([ye()],Pr.prototype,"content",2),Fi([ye()],Pr.prototype,"placement",2),Fi([ye({type:Boolean,reflect:!0})],Pr.prototype,"disabled",2),Fi([ye({type:Number})],Pr.prototype,"distance",2),Fi([ye({type:Boolean,reflect:!0})],Pr.prototype,"open",2),Fi([ye({type:Number})],Pr.prototype,"skidding",2),Fi([ye()],Pr.prototype,"trigger",2),Fi([ye({type:Boolean})],Pr.prototype,"hoist",2),Fi([Sr("open",{waitUntilFirstUpdate:!0})],Pr.prototype,"handleOpenChange",1),Fi([Sr(["content","distance","hoist","placement","skidding"])],Pr.prototype,"handleOptionsChange",1),Fi([Sr("disabled")],Pr.prototype,"handleDisabledChange",1),Mi("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}}),Mi("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}});Pr.define("sl-tooltip");var Rr=Object.defineProperty,Or=Object.getOwnPropertyDescriptor,Ar=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?Or(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&Rr(t,o,r),r};Mi("tooltip.show",null),Mi("tooltip.hide",null);let Er=class extends lit_element_r{constructor(){super(...arguments),this.placement="bottom",this.disabled=!1}firstUpdated(){this.observer=new MutationObserver((e=>{for(const t of e)if("attributes"===t.type&&"data-current-placement"===t.attributeName){const e=t.target.getAttribute("data-current-placement");e?this.setAttribute("data-current-placement",e):this.removeAttribute("data-current-placement")}}));const e=this.shadowRoot?.querySelector("sl-tooltip")?.shadowRoot;e&&this.observer.observe(e,{attributes:!0,attributeFilter:["data-current-placement"],subtree:!0})}disconnectedCallback(){this.observer?.disconnect()}render(){return ne`<sl-tooltip
			.placement=${this.placement}
	...
	`,Ar([ye()],Er.prototype,"content",2),Ar([ye({reflect:!0})],Er.prototype,"placement",2),Ar([ye({type:Boolean})],Er.prototype,"disabled",2),Ar([ye({type:Number})],Er.prototype,"distance",2),Ar([ye({type:Boolean})],Er.prototype,"hoist",2),Er=Ar([fe("gl-tooltip")],Er);var Tr=Object.defineProperty,Dr=Object.getOwnPropertyDescriptor,Ir=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?Dr(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&Tr(t,o,r),r};let Lr=class extends lit_element_r{constructor(){super(...arguments),this.disabled=!1,this.full=!1}get role(){return this.href?"link":"button"}updated(e){super.updated(e),e.has("disabled")&&this.setAttribute("aria-disabled",this.disabled.toString())}render(){return this.tooltip?ne`<gl-tooltip .content=${this.tooltip}>${this.renderControl()}</gl-tooltip>`:this.querySelectorAll('[slot="tooltip"]').length>0?ne`<gl-tooltip>
				${this.renderControl()}
			...
			<slot name="prefix"></slot><slot class="label"></slot><slot name="suffix"></slot>
		</button>`}onLinkKeypress(e){" "===e.key&&this.control.click()}focus(e){this.control.focus(e)}blur(){this.control.blur()}click(){this.control.click()}};Lr.shadowRootOptions={...lit_element_r.shadowRootOptions,delegatesFocus:!0},Lr.styles=[qo,p`
			:host {
		...
		`],Ir([ke(".control")],Lr.prototype,"control",2),Ir([ye({reflect:!0})],Lr.prototype,"appearance",2),Ir([ye({type:Boolean,reflect:!0})],Lr.prototype,"disabled",2),Ir([ye({reflect:!0})],Lr.prototype,"density",2),Ir([ye({type:Boolean,reflect:!0})],Lr.prototype,"full",2),Ir([ye()],Lr.prototype,"href",2),Ir([ye({reflect:!0})],Lr.prototype,"role",1),Ir([ye()],Lr.prototype,"tooltip",2),Lr=Ir([fe("gl-button")],Lr);var Fr=Object.defineProperty,Wr=Object.getOwnPropertyDescriptor,zr=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?Wr(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&Fr(t,o,r),r};let Br=class extends lit_element_r{constructor(){super(...arguments),this.editor=!1}render(){return ne`<div class="group"><slot></slot></div>`}};Br.styles=[qo,p`
			:host {
				display: block;
				max-width: 30rem;
				margin-right: auto;
	...
	`,Mr([ye({reflect:!0})],Vr.prototype,"icon",2),Mr([ye({reflect:!0})],Vr.prototype,"modifier",2),Mr([ye({type:Number})],Vr.prototype,"size",2),Mr([ye({reflect:!0})],Vr.prototype,"flip",2),Mr([ye({reflect:!0})],Vr.prototype,"rotate",2),Vr=Mr([fe("code-icon")],Vr);const Gr=e=>e??ae;var qr=Object.defineProperty,Hr=Object.getOwnPropertyDescriptor,Kr=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?Hr(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&qr(t,o,r),r};let Qr=class extends lit_element_r{constructor(){super(...arguments),this.type="info"}get hasPromo(){return null!=this.promo}render(){if(!this.promo)return;const e=this.renderPromo(this.promo);return e?"link"===this.type?ne`<a
				class="link"
				href="${this.promo.command?.command??"command:gitlens.plus.upgrade"}"
				title="${Gr(this.promo.command?.tooltip)}"
				>${e}</a
			>`:ne`<p class="promo">${e}</p>`:void 0}renderPromo(e){switch(e.key){case"pro50":return ne`<span class="content${"link"===this.type?ae:" muted"}"
		...
		`],Kr([ye({type:Object})],Qr.prototype,"promo",2),Kr([ye({reflect:!0,type:String})],Qr.prototype,"type",2),Kr([ye({reflect:!0,type:Boolean,attribute:"has-promo"})],Qr.prototype,"hasPromo",1),Qr=Kr([fe("gl-promo")],Qr);var Jr=Object.defineProperty,Yr=Object.getOwnPropertyDescriptor,Zr=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?Yr(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&Jr(t,o,r),r};let Xr=class extends lit_element_r{get daysRemaining(){return null==this._state.subscription?0:yi(this._state.subscription,"days")??0}get hasAccount(){return null!=(e=this.state)&&e!==ii.Community&&e!==ii.ProPreviewExpired&&e!==ii.ProPreview;var e}get isReactivatedTrial(){return this.state===ii.ProTrial&&(this._state.subscription?.plan.effective.trialReactivationCount??0)>0}get planId(){return this._state.subscription?.plan.actual.id??oi.Pro}get planName(){return function(e,t){switch(e){case ii.Community:case ii.ProPreviewExpired:return vi(oi.Community);case ii.ProPreview:return`${vi(oi.Pro)} (Preview)`;case ii.ProTrial:return`${vi(oi.Pro)} (Trial)`;case ii.ProTrialExpired:case ii.ProTrialReactivationEligible:return vi(oi.CommunityWithAccount);case ii.VerificationRequired:return`${vi(t??oi.Pro)} (Unverified)`;default:return vi(t??oi.Pro)}}(this.state,this.planId)}get state(){return this._state.subscription?.state}render(){return ne`<gl-accordion id="accordion">
			<div class="header" slot="header">
				...
				${xe(this.state===ii.ProTrialReactivationEligible,(()=>ne`
						<gl-button
							appearance="secondary"
							tight
							href="command:gitlens.plus.reactivateProTrial"
							tooltip="Reactivate your Pro trial for another ${mo("day",ti)}"
							>Reactivate Pro Trial</gl-button
						>
					`))}
				${xe(this.hasAccount,(()=>ne`
						<span class="header__actions">
							${xe(!this._state.hasAnyIntegrationConnected,(()=>ne`
									<gl-button
										appearance="toolbar"
			...
			<div class="org">
				...
				${xe(this._state.organizationsCount>1,(()=>ne`<div class="org__signout">
							<gl-button
								appearance="toolbar"
		...
		`:ae}renderAccountState(){const e=ri(this.state,"account");switch(this.state){case ii.Paid:return ne`
					<div class="account">
						<button-container>
						...
						<p>
							Your ${vi(this.planId)} plan provides full access to all GitLens Pro
				...
				`;case ii.VerificationRequired:return ne`
					<div class="account">
				...
				`;case ii.ProTrial:{const t=this.daysRemaining;return ne`
					<div class="account">
				...
				`}case ii.ProTrialExpired:return ne`
					<div class="account">
				...
				`;case ii.ProTrialReactivationEligible:return ne`
					<div class="account">
						<p>
				...
				`;default:return ne`
					<div class="account">
						...
						<p>Get ${ti} days of GitLens Pro for free — no credit card required.</p>
					</div>
		...
		`],Zr([ke("#accordion")],Xr.prototype,"accordionEl",2),Zr([r({context:ei,subscribe:!0}),we()],Xr.prototype,"_state",2),Xr=Zr([fe("gl-home-account-content")],Xr);var ts=Object.defineProperty,os=Object.getOwnPropertyDescriptor,is=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?os(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&ts(t,o,r),r};let ns=class extends lit_element_r{render(){return this.name?ne`<gl-tooltip .content=${this.name}>${this.renderAvatar()}</gl-tooltip>`:this.renderAvatar()}renderAvatar(){return this.href?ne`<a href=${this.href} class="avatar">${this.renderContent()}</a>`:ne`<span class="avatar">${this.renderContent()}</span>`}renderContent(){return this.src?ne`<img class="thumb thumb--media" src="${this.src}" alt="${this.name}" />`:ne`<slot class="thumb thumb--text"></slot>`}};ns.styles=[p`
			:host {
				display: inline-block;
		...
		</sl-popup>`}};ls.shadowRootOptions={...lit_element_r.shadowRootOptions,delegatesFocus:!0},ls.styles=p`
		:host {
			--hide-delay: 0ms;
			--show-delay: 500ms;
	...
	`,as([ke("#popover")],ls.prototype,"body",2),as([ke("sl-popup")],ls.prototype,"popup",2),as([ye({reflect:!0})],ls.prototype,"placement",2),as([ye({type:Object})],ls.prototype,"anchor",2),as([ye({reflect:!0,type:Boolean})],ls.prototype,"disabled",2),as([ye({type:Number})],ls.prototype,"distance",2),as([ye({reflect:!0,type:Boolean})],ls.prototype,"open",2),as([ye({reflect:!0,type:Boolean})],ls.prototype,"arrow",2),as([ye({type:Number})],ls.prototype,"skidding",2),as([ye()],ls.prototype,"trigger",2),as([ye({type:Boolean})],ls.prototype,"hoist",2),as([to("open",{afterFirstUpdate:!0})],ls.prototype,"handleOpenChange",1),as([to(["distance","hoist","placement","skidding"])],ls.prototype,"handleOptionsChange",1),as([to("disabled")],ls.prototype,"handleDisabledChange",1),ls=as([fe("gl-popover")],ls);var cs=Object.defineProperty,ds=Object.getOwnPropertyDescriptor,hs=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?ds(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&cs(t,o,r),r};let ps=class extends lit_element_r{constructor(){super(...arguments),this.max=3,this.avatars=[]}render(){return ne`<gl-avatar-group>${this.renderList()}</gl-avatar-group>`}renderList(){const e=this.avatars.slice(0,this.max),t=this.avatars.slice(this.max);return ne`
			${e.map((e=>ne`<gl-avatar .src=${e.src} .name=${e.name} .href=${e.href}></gl-avatar>`))}
			${xe(t.length>0,(()=>ne`<gl-popover>
		...
		`}};hs([ye({type:Number})],ps.prototype,"max",2),hs([ye({type:Array})],ps.prototype,"avatars",2),ps=hs([fe("gl-avatar-list")],ps);let us=class extends lit_element_r{render(){return ne`<slot class="avatar-group" part="base"></slot>`}};us.styles=[p`
			.avatar-group {
				display: inline-flex;
				flex-direction: row;
				justify-content: center;
		...
		`],us=hs([fe("gl-avatar-group")],us);const gs=p`
	.card {
		display: block;
		flex-direction: column;
		gap: 0.8rem;
...
`;var ms=Object.defineProperty,fs=Object.getOwnPropertyDescriptor,bs=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?fs(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&ms(t,o,r),r};let vs=class extends lit_element_r{constructor(){super(...arguments),this.active=!1}render(){return null!=this.href?ne`<a part="base" class="card${this.active?" is-active":""}" href=${this.href}
		...
		`}focus(e){null!=this.href?this.shadowRoot?.querySelector("a")?.focus(e):super.focus(e)}};vs.shadowRootOptions={...lit_element_r.shadowRootOptions,delegatesFocus:!0},vs.styles=[gs],bs([ye({type:Boolean,reflect:!0})],vs.prototype,"active",2),bs([ye()],vs.prototype,"href",2),vs=bs([fe("gl-card")],vs);var ys=Object.defineProperty,ws=Object.getOwnPropertyDescriptor,_s=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?ws(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&ys(t,o,r),r};const ks=Object.freeze({added:["+","add"],modified:["~","edit"],removed:["-","trash"]});let xs=class extends lit_element_r{constructor(){super(...arguments),this.added=0,this.modified=0,this.removed=0}render(){return Object.entries(ks).map((([e,t])=>this.renderStat(e,t)))}renderStat(e,t){const o=this[e];return null==o?ae:ne`<span class="stat ${e}" title="${o} ${e}" aria-label="${o} ${e}"
			><span class="label">${this.renderSymbol(t)}${o}</span></span
		>`}renderSymbol([e,t]){return"icons"===this.symbol?ne`<code-icon class="icon" icon="${t}"></code-icon>`:ne`<span>${e}</span>`}};xs.styles=p`
		:host {
			display: inline-flex;
			flex-direction: row;
			align-items: center;
	...
	`,_s([ye({type:Number})],xs.prototype,"added",2),_s([ye({type:Number})],xs.prototype,"modified",2),_s([ye({type:Number})],xs.prototype,"removed",2),_s([ye()],xs.prototype,"symbol",2),xs=_s([fe("commit-stats")],xs);var $s=Object.defineProperty,Cs=Object.getOwnPropertyDescriptor,Ss=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?Cs(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&$s(t,o,r),r};let Ps=class extends lit_element_r{constructor(){super(...arguments),this.dateStyle="relative",this.date=new Date}render(){const e=mi(this.date,this.format??"MMMM Do, YYYY h:mma");return ne`<gl-tooltip content="${e}"
			><time datetime="${this.date.toISOString()}"
				>${"relative"===this.dateStyle?function(e,t){const o=("number"==typeof e?e:e.getTime())-(new Date).getTime();for(const[e,i,n,r]of ci){const a=Math.abs(o);if(a>=i||1e3===i)return t?(null==di&&(null!=gi?di=gi.resolvedOptions().locale:null!=ui?di=ui.resolvedOptions().locale:(gi=new Intl.RelativeTimeFormat(pi,{localeMatcher:"best fit",numeric:"always",style:"narrow"}),di=gi.resolvedOptions().locale)),"en"===di||di?.startsWith("en-")?`${Math.round(a/n)}${r}`:(null==gi&&(gi=new Intl.RelativeTimeFormat(pi,{localeMatcher:"best fit",numeric:"always",style:"narrow"})),gi.format(Math.round(o/n),e))):(null==ui&&(ui=new Intl.RelativeTimeFormat(pi,{localeMatcher:"best fit",numeric:"auto",style:"long"})),ui.format(Math.round(o/n),e))}return""}(this.date):e}</time
			></gl-tooltip
		>`}};Ss([ye()],Ps.prototype,"format",2),Ss([ye({attribute:"date-style"})],Ps.prototype,"dateStyle",2),Ss([ye({converter:{toAttribute:e=>e.getTime(),fromAttribute:(e,t)=>new Date(parseInt(e,10))},reflect:!0})],Ps.prototype,"date",2),Ps=Ss([fe("formatted-date")],Ps);const Rs=p`
	:host {
		box-sizing: border-box;
		display: inline-block;
...
`;var Os=Object.defineProperty,As=Object.getOwnPropertyDescriptor,Es=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?As(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&Os(t,o,r),r};let Ts=class extends lit_element_r{constructor(){super(...arguments),this.ahead=0,this.behind=0,this.working=0,this.outlined=!1,this.colorized=!1}render(){return 0===this.ahead&&0===this.behind&&0===this.working?ae:ne`<span part="base" class="pill${this.outlined?" pill--outlined":""}"
			>${xe(this.behind>0,(()=>ne`<span class="state${this.colorized?" state--behind":""}"
						>${this.behind}<code-icon icon="arrow-down"></code-icon
					></span>`))}${xe(this.ahead>0,(()=>ne`<span class="state${this.colorized?" state--ahead":""}"
						>${this.ahead}<code-icon icon="arrow-up"></code-icon
					></span>`))}${xe(this.working>0,(()=>ne`<span class="state${this.colorized?" state--working":""}"
		...
		`],Es([ye({type:Number})],Ts.prototype,"ahead",2),Es([ye({type:Number})],Ts.prototype,"behind",2),Es([ye({type:Number})],Ts.prototype,"working",2),Es([ye({type:Boolean})],Ts.prototype,"outlined",2),Es([ye({type:Boolean})],Ts.prototype,"colorized",2),Ts=Es([fe("gl-tracking-pill")],Ts);const Ds=p`
	.pr-icon--opened {
...
`;var Is=Object.defineProperty,Ls=Object.getOwnPropertyDescriptor,Fs=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?Ls(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&Is(t,o,r),r};let Ws=class extends lit_element_r{get icon(){let e="git-pull-request";if(this.state)switch(this.state){case"merged":e="git-merge";break;case"closed":e="git-pull-request-closed"}return e}get classes(){return this.state?`pr-icon pr-icon--${this.state}`:"pr-icon"}render(){return ne`<code-icon
			class=${this.classes}
			icon=${this.icon}
			aria-label=${Gr(this.state)}
		></code-icon>`}};Ws.styles=[Ds],Fs([ye()],Ws.prototype,"state",2),Ws=Fs([fe("pr-icon")],Ws);var zs=Object.defineProperty,Bs=Object.getOwnPropertyDescriptor,Ns=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?Bs(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&zs(t,o,r),r};let js=class extends lit_element_r{constructor(){super(...arguments),this.icon="",this.disabled=!1}render(){return ne`
	...
	`,Ns([ye()],js.prototype,"href",2),Ns([ye()],js.prototype,"label",2),Ns([ye()],js.prototype,"icon",2),Ns([ye({type:Boolean})],js.prototype,"disabled",2),js=Ns([fe("action-item")],js);var Ms=Object.defineProperty,Us=Object.getOwnPropertyDescriptor,Vs=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?Us(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&Ms(t,o,r),r};let Gs=class extends lit_element_r{firstUpdated(){this.role="navigation"}disconnectedCallback(){this._slotSubscriptionsDisposer?.()}render(){return ne`<slot @slotchange=${this.handleSlotChange}></slot>`}handleSlotChange(e){if(this._slotSubscriptionsDisposer?.(),this.actionNodes.length<2)return;const t=this.handleKeydown.bind(this),o=`${this.actionNodes.length}`,i=this.actionNodes.map(((e,i)=>(e.setAttribute("aria-posinset",`${i+1}`),e.setAttribute("aria-setsize",o),e.setAttribute("tabindex",0===i?"0":"-1"),e.addEventListener("keydown",t,!1),{dispose:()=>{e?.removeEventListener("keydown",t,!1)}})));this._slotSubscriptionsDisposer=()=>{i?.forEach((({dispose:e})=>e()))}}handleKeydown(e){if(!e.target||null==this.actionNodes||this.actionNodes.length<2)return;const t=e.target,o=parseInt(t.getAttribute("aria-posinset")??"0",10);let i=null;if("ArrowLeft"===e.key){const e=1===o?this.actionNodes.length-1:o-2;i=this.actionNodes[e]}else if("ArrowRight"===e.key){const e=o===this.actionNodes.length?0:o;i=this.actionNodes[e]}null!=i&&i!==t&&(t.setAttribute("tabindex","-1"),i.setAttribute("tabindex","0"),i.focus())}};Gs.styles=p`
		:host {
			display: flex;
			align-items: center;
			user-select: none;
		}
	`,Vs([function(e){return(t,o)=>{const{slot:i,selector:n}=e??{},r="slot"+(i?`[name=${i}]`:":not([name])");return _e(t,o,{get(){const t=this.renderRoot?.querySelector(r),o=t?.assignedElements(e)??[];return void 0===n?o:o.filter((e=>e.matches(n)))}})}}({flatten:!0})],Gs.prototype,"actionNodes",2),Gs=Vs([fe("action-nav")],Gs);var qs=Object.defineProperty,Hs=Object.getOwnPropertyDescriptor,Ks=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?Hs(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&qs(t,o,r),r};let Qs=class extends lit_element_r{render(){return ne`
			<div class="section">
		...
		`],Qs=Ks([fe("gl-section")],Qs);let Js=class extends lit_element_r{constructor(){super(...arguments),this.isFetching=!1}renderSectionLabel(){return this.isFetching||0===this.branches.length?this.label:`${this.label} (${this.branches.length})`}render(){return ne`
			<gl-section>
				<span slot="heading">${this.renderSectionLabel()}</span>
				<span slot="heading-actions"><slot name="heading-actions"></slot></span>
				${this.branches.map((e=>ne`<gl-branch-card .repo=${this.repo} .branch=${e}></gl-branch-card>`))}
				${xe(this.branches.length>0,(()=>this.branches.map((e=>ne`<gl-branch-card .repo=${this.repo} .branch=${e}></gl-branch-card>`))),(()=>ne`<p>No ${this.label} branches</p>`))}
			</gl-section>
		`}};Ks([ye({type:String})],Js.prototype,"label",2),Ks([ye()],Js.prototype,"repo",2),Ks([ye({type:Array})],Js.prototype,"branches",2),Ks([ye({type:Boolean})],Js.prototype,"isFetching",2),Js=Ks([fe("gl-branch-section")],Js);const Ys=p`
	.heading-loader {
		flex: 1;
	}
`,Zs=p`
...
`;let Xs=class extends lit_element_r{get branchRefs(){return{repoPath:this.repo,branchId:this.branch.id}}render(){const{name:e,pr:t,opened:o,timestamp:i}=this.branch;return ne`
				...
				<div class="branch-item__container">
					<div class="branch-item__section">
						<p class="branch-item__grouping">
							...
							${xe(t,(e=>ne`<span class="branch-item__name">${e.title} </span
		...
		`:ae}renderChanges(e){const{state:t,workingTreeState:o}=e,i=this.renderWip(o),n=this.renderTracking(t),r=this.renderAvatars(e);return i||n||r?ne`<p class="branch-item__changes">${i}${n}${r}</p>`:ae}renderIcon(e,t){return e.pr&&!t?ne`<pr-icon state=${e.pr.state}></pr-icon>`:e.worktree?ne`<code-icon icon="gl-worktrees-view"></code-icon>`:ne`<code-icon icon="git-branch"></code-icon>`}renderAvatars(e){const t=[];if(e.owner&&t.push(e.owner),e.contributors&&t.push(...e.contributors),0!==t.length)return ne`<gl-avatar-list
		...
		></gl-avatar-list>`}renderWip(e){if(e?.added||e?.changed||e?.deleted)return ne`<commit-stats
			...
			></action-item>`),e.length?ne`<action-nav class="branch-item__actions">${e}</action-nav>`:ae}createCommandLink(e){return ea(e,this.branchRefs)}};function ea(e,t){return null==t?`command:${e}`:`command:${e}?${encodeURIComponent("string"==typeof t?t:JSON.stringify(t))}`}Xs.styles=Zs,Ks([ye()],Xs.prototype,"repo",2),Ks([ye({type:Object})],Xs.prototype,"branch",2),Xs=Ks([fe("gl-branch-card")],Xs);var ta=Object.defineProperty,oa=Object.getOwnPropertyDescriptor,ia=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?oa(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&ta(t,o,r),r};let na=class extends lit_element_r{constructor(){super(...arguments),this.lines=1}render(){const e=`--skeleton-lines: ${this.lines};`;return ne`<div class="skeleton" style=${e}></div>`}};na.styles=p`
		:host {
	...
	`,ia([ye({type:Number})],na.prototype,"lines",2),na=ia([fe("skeleton-loader")],na);var ra=Object.defineProperty,sa=Object.getOwnPropertyDescriptor,aa=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?sa(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&ra(t,o,r),r};let la=class extends lit_element_r{constructor(){super(...arguments),this.disabled=!1,this.role="option"}updateInteractiveState(){this.tabIndex=this.disabled?-1:"option"===this.role?0:-1}updated(e){(e.has("disabled")||e.has("role"))&&this.updateInteractiveState()}render(){return this.href?ne`<a href=${this.href}><slot></slot></a>`:ne`<slot></slot>`}};la.styles=[qo,p`
			:host {
				display: block;
				font-family: inherit;
				border: none;
		...
		`],aa([ye({type:Boolean,reflect:!0})],la.prototype,"disabled",2),aa([ye({reflect:!0})],la.prototype,"href",2),aa([ye({reflect:!0})],la.prototype,"role",2),la=aa([fe("menu-item")],la);var ca=Object.defineProperty,da=Object.getOwnPropertyDescriptor,ha=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?da(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&ca(t,o,r),r};let pa=class extends(At(lit_element_r)){connectedCallback(){super.connectedCallback(),this._homeState.repositories.openCount>0&&this._overviewState.run()}render(){return this._homeState.discovering?this.renderLoader():0===this._homeState.repositories.openCount?ae:this._overviewState.render({pending:()=>this.renderPending(),complete:e=>this.renderComplete(e),error:()=>ne`<span>Error</span>`})}renderLoader(){return ne`
			<gl-section>
		...
		`}renderPending(){return null==this._overviewState.state?this.renderLoader():this.renderComplete(this._overviewState.state,!0)}renderComplete(e,t=!1){const o=e?.repository,i=o?.branches?.active;return i?ne`
			<gl-section>
				<span slot="heading"
					><code-icon icon="repo" class="heading-icon"></code-icon> ${e.repository.name}</span
				>
				<span slot="heading-actions"
					...
					></gl-button>
					${xe(this._homeState.repositories.openCount>1,(()=>ne`<gl-button
								aria-busy="${Gr(t)}"
								?disabled=${t}
								class="section-heading-action"
								appearance="toolbar"
		...
		`:ne`<span>None</span>`}renderRepoBranchCard(e,t,o){const{name:i,pr:n,state:r,workingTreeState:a,upstream:l}=e;return ne`
			<gl-card class="branch-item" active>
				<div class="branch-item__container">
					...
					${xe(r,(()=>this.renderBranchStateActions(r,l,o)))}
					${xe(n,(e=>ne`<div class="branch-item__section">
							<p class="branch-item__grouping">
								<span class="branch-item__icon">
									<pr-icon state=${e.state}></pr-icon>
								</span>
								<span class="branch-item__name">${e.title}</span>
								<a href=${e.url} class="branch-item__identifier">#${e.id}</a>
							</p>
						</div>`))}
					${xe(a,(()=>this.renderStatus(a,r)))}
				</div>
		...
		`}renderActions(e,t){const o={repoPath:t,branchId:e.id},i=[];return e.pr?(i.push(ne`<action-item
					label="Open Pull Request Changes"
					icon="request-changes"
					href=${ea("gitlens.home.openPullRequestComparison",o)}
				></action-item>`),i.push(ne`<action-item
					label="Open Pull Request on Remote"
					icon="globe"
					href=${ea("gitlens.home.openPullRequestOnRemote",o)}
				></action-item>`)):!1===e.upstream?.missing&&i.push(ne`<action-item
					label="Create Pull Request..."
					icon="git-pull-request-create"
					href=${ea("gitlens.home.createPullRequest",o)}
				></action-item>`),i.push(ne`<action-item
				label="Fetch"
				icon="gl-repo-fetch"
				href=${ea("gitlens.home.fetch",o)}
			></action-item>`),i.length?ne`<action-nav class="branch-item__actions">${i}</action-nav>`:ae}renderBranchStateActions(e,t,o){if(!1!==t?.missing){const e=t?.name?`Publish branch to ${t.name}`:"Publish branch";return ne`<div>
				<button-container>
					<gl-button
						aria-busy=${Gr(o)}
						?disabled=${o}
						href=${es("gitlens.views.home.publishBranch","gitlens.views.home","")}
						full
						appearance="secondary"
						tooltip="${e}"
				...
				>
					...
					<button-container>
						<gl-button
							aria-busy=${Gr(o)}
							?disabled=${o}
							href=${es("gitlens.views.home.pull","gitlens.views.home","")}
							full
							appearance="secondary"
							tooltip=${i}
						...
						<gl-button
							aria-busy=${Gr(o)}
							?disabled=${o}
							href=${es("gitlens.views.home.push","gitlens.views.home","",{force:!0})}
							appearance="secondary"
							density="compact"
							tooltip=${n}
					...
					<button-container>
						<gl-button
							aria-busy=${Gr(o)}
							?disabled=${o}
							href=${es("gitlens.views.home.push","gitlens.views.home","")}
							full
							appearance="secondary"
							tooltip=${i}
					...
					removed=${e.deleted}
					symbol="icons"
				></commit-stats>`),o.length?ne`<p class="branch-item__section branch-item__section--details">${o}</p>`:ae}onChange(e){this._overviewState.changeRepository()}};pa.styles=[Zs,Ys,p`
			[hidden] {
				display: none;
			}
			:host {
		...
		`}renderSummaryResult(){return!1===this._homeState.hasAnyIntegrationConnected?ne`<ul class="menu">
			...
			`:this.renderSummary(this._summaryState.state)}renderSummary(e){if(null==e)return ae;if(0===e.total)return ne`<ul class="menu">
				...
				<li>(${e.total} other pull requests)</li>
						...
						</li>`);break}}}return ne`<menu class="menu">${t}</menu>`}};va.shadowRootOptions={...lit_element_r.shadowRootOptions,delegatesFocus:!0},va.styles=[p`
			:host {
				display: block;
				margin-bottom: 2.4rem;
				color: var(--vscode-foreground);
		...
		`],ba([r({context:ei,subscribe:!0}),we()],va.prototype,"_homeState",2),ba([r({context:xo})],va.prototype,"_ipc",2),va=ba([fe("gl-launchpad")],va);const ya=(e,t,o)=>{const i=new Map;for(let n=t;n<=o;n++)i.set(e[n],n);return i},wa=Dt(class extends directive_i{constructor(e){if(super(e),e.type!==Tt)throw Error("repeat() can only be used in text expressions")}dt(e,t,o){let i;void 0===o?o=t:void 0!==t&&(i=t);const n=[],r=[];let a=0;for(const t of e)n[a]=i?i(t,a):a,r[a]=o(t,a),a++;return{values:r,keys:n}}render(e,t,o){return this.dt(e,t,o).values}update(e,[t,o,i]){const n=(e=>e._$AH)(e),{values:r,keys:a}=this.dt(t,o,i);if(!Array.isArray(n))return this.ut=a,r;const l=this.ut??=[],c=[];let d,h,p=0,u=n.length-1,g=0,m=r.length-1;for(;p<=u&&g<=m;)if(null===n[p])p++;else if(null===n[u])u--;else if(l[p]===a[g])c[g]=Wt(n[p],r[g]),p++,g++;else if(l[u]===a[m])c[m]=Wt(n[u],r[m]),u--,m--;else if(l[p]===a[m])c[m]=Wt(n[p],r[m]),Ft(e,c[m+1],n[p]),p++,m--;else if(l[u]===a[g])c[g]=Wt(n[u],r[g]),Ft(e,n[p],n[u]),u--,g++;else if(void 0===d&&(d=ya(a,g,m),h=ya(l,p,u)),d.has(l[p]))if(d.has(l[u])){const t=h.get(a[g]),o=void 0!==t?n[t]:null;if(null===o){const t=Ft(e,n[p]);Wt(t,r[g]),c[g]=t}else c[g]=Wt(o,r[g]),Ft(e,n[p],o),n[t]=null;g++}else Bt(n[u]),u--;else Bt(n[p]),p++;for(;g<=m;){const t=Ft(e,c[m+1]);Wt(t,r[g]),c[g++]=t}for(;p<=u;){const e=n[p++];null!==e&&Bt(e)}return this.ut=a,((e,t=zt)=>{e._$AH=t})(e,c),se}}),_a=p`
	:host {
...
`;var ka=Object.defineProperty,xa=Object.getOwnPropertyDescriptor,$a=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?xa(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&ka(t,o,r),r};let Ca=class extends GlElement{constructor(){super(),this.disabled=!1,this.value="",this._defaultChecked=!1,this.checked=!1,this._defaultChecked=this.checked}get defaultChecked(){return this._defaultChecked}handleChange(e){this.checked=e.target.checked;const t=new CustomEvent("gl-change-value");this.dispatchEvent(t)}renderCheck(){if(this.checked)return ne` <code-icon icon="check"></code-icon> `}render(){return ne`<label ?aria-disabled=${this.disabled}
		...
		</label>`}};Ca.shadowRootOptions={...GlElement.shadowRootOptions,delegatesFocus:!0},Ca.styles=[_a],$a([ye({type:Boolean,reflect:!0})],Ca.prototype,"disabled",2),$a([ye({type:String})],Ca.prototype,"value",2),$a([ye({type:Boolean})],Ca.prototype,"defaultChecked",1),$a([ye({type:Boolean,reflect:!0})],Ca.prototype,"checked",2),Ca=$a([fe("gl-checkbox")],Ca);var Sa=Object.defineProperty,Pa=Object.getOwnPropertyDescriptor,Ra=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?Pa(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&Sa(t,o,r),r};const Oa=p`
	.select {
		background: none;
		outline: none;
		border: none;
...
`;class GlObjectSelect extends GlElement{constructor(){super(...arguments),this.disabled=!1}render(){if(this.options)return ne`
			<select .disabled=${this.disabled} class="select" @change=${e=>this.onChange?.(e)}>
				${wa(this.options,(e=>{const t=this.getValue(e),o=this.getLabel(e);return ne`<option .value="${t}" ?selected=${this.value===t}>${o}</option>`}))}
			</select>
		`}}GlObjectSelect.styles=[Oa],Ra([ye({type:Boolean})],GlObjectSelect.prototype,"disabled",2),Ra([ye({type:String})],GlObjectSelect.prototype,"value",2),Ra([ye({type:Array})],GlObjectSelect.prototype,"options",2);let Aa=class extends GlObjectSelect{getValue(e){return e.value}getLabel(e){return e.label}onChange(e){const t=new CustomEvent("gl-change",{detail:{threshold:e.target.value}});this.dispatchEvent(t)}};Aa=Ra([fe("gl-branch-threshold-filter")],Aa);var Ea=Object.defineProperty,Ta=Object.getOwnPropertyDescriptor,Da=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?Ta(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&Ea(t,o,r),r};let Ia=class extends(At(lit_element_r)){connectedCallback(){super.connectedCallback(),this._homeState.repositories.openCount>0&&this._overviewState.run()}render(){return this._homeState.discovering?this.renderLoader():0===this._homeState.repositories.openCount?ae:this._overviewState.render({pending:()=>this.renderPending(),complete:e=>this.renderComplete(e),error:()=>ne`<span>Error</span>`})}renderLoader(){return ne`
			<gl-section>
				<skeleton-loader slot="heading" class="heading-loader" lines="1"></skeleton-loader>
				<skeleton-loader lines="3"></skeleton-loader>
			</gl-section>
		`}renderPending(){return null==this._overviewState.state?this.renderLoader():this.renderComplete(this._overviewState.state,!0)}onChangeRecentThresholdFilter(e){this._overviewState.filter.stale&&this._overviewState.filter.recent&&this._ipc.sendCommand(Fe,{stale:this._overviewState.filter.stale,recent:{...this._overviewState.filter.recent,threshold:e.detail.threshold}})}renderComplete(e,t=!1){if(null==e)return ae;const{repository:o}=e;return ne`
			...
			${xe(!0===this._overviewState.filter.stale?.show,(()=>ne`
					<gl-branch-section
						label="stale"
						.repo=${o.path}
		...
		`],Da([r({context:ei,subscribe:!0}),we()],Ia.prototype,"_homeState",2),Da([r({context:Qt})],Ia.prototype,"_overviewState",2),Da([r({context:xo})],Ia.prototype,"_ipc",2),Ia=Da([fe("gl-overview")],Ia);var La=Object.defineProperty,Fa=Object.getOwnPropertyDescriptor,Wa=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?Fa(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&La(t,o,r),r};let za=class extends lit_element_r{constructor(){super(...arguments),this.cloud=!1,this.placement="bottom",this.preview=!1}get daysRemaining(){return null==this.subscription?0:yi(this.subscription,"days")??0}get state(){return this.subscription?.state}render(){return ne`
		...
		`}renderBadge(){const e=this.preview?"Preview":"Pro";if(null!=this.subscription){if(this.state===ii.VerificationRequired)return ne`${e} <code-icon class="badge-icon" icon="warning" size="10"></code-icon>`;if(_i(this.subscription)||this.cloud&&null!=this.subscription.account)return ne`${e} <code-icon class="badge-icon" icon="check" size="10"></code-icon>`;if(null!=(t=this.state)&&(t===ii.ProPreview||t===ii.ProTrial))return ne`${e} <code-icon class="badge-icon" icon="clock" size="10"></code-icon>`}var t;return e}renderPopoverHeader(){const e=ne`<span class="popup-title">${this.preview?"Preview feature":"Pro feature"}</span>`;return this.state===ii.Paid?ne`<div class="popup-header">${e}</div>`:this.cloud?this.preview?ne`<div class="popup-header">
			...
			${e}<span class="popup-subtitle"> Requires GitLens Pro for use on privately-hosted repos</span>
		</div>`}renderPopoverContent(){if(null==this.subscription)return ae;let e;switch(this.state){case ii.Paid:e=ne`<p>
					Your
					<gl-tooltip hoist content="Show Account view">
						<a href="${Ba(ua.ShowAccountView,void 0)}"
							>${vi(this.subscription?.plan.actual.id??oi.Pro)}</a
						>
					</gl-tooltip>
					plan provides access to all Pro features.
				</p>`;break;case ii.VerificationRequired:e=ne`<p>You must verify your email before you can access Pro features.</p>
					<div class="actions">
						<gl-button
							appearance="primary"
							density="tight"
							href="${Ba(ua.PlusResendVerification,this.source)}"
							>Resend Email</gl-button
						>
						<gl-button
							appearance="secondary"
							density="tight"
							href="${Ba(ua.PlusValidate,this.source)}"
							><code-icon icon="refresh"></code-icon
						></gl-button>
					</div>`;break;case ii.ProTrial:{const t=this.daysRemaining;e=ne`<p>
						You have
						<strong>${t<1?"<1 day":mo("day",t,{infix:" more "})} left</strong>
						in your Pro trial. Once your trial ends, you will only be able to use Pro features on
						publicly-hosted repos.
					</p>
					${this.renderUpgradeActions()}`;break}case ii.ProTrialExpired:e=ne`<p>
						Your Pro trial has ended. You can now only use Pro features on publicly-hosted repos.
					</p>
					${this.renderUpgradeActions(ne`<p>Please upgrade for full access to all GitLens Pro features:</p>`)}`;break;case ii.ProTrialReactivationEligible:e=ne`<p>
					...
					<div class="actions center">
						<gl-button
							appearance="primary"
							density="tight"
							href="${Ba(ua.PlusReactivateProTrial,this.source)}"
							tooltip="Reactivate your Pro trial for another ${mo("day",ti)}"
							>Reactivate Pro Trial</gl-button
						>
					</div>`;break;default:if(!this.cloud&&this.state===ii.ProPreview){const t=this.daysRemaining;e=ne`<p>
							You have
							<strong>${t<1?"<1 day":mo("day",t,{infix:" more "})} left</strong>
							to preview
			...
			<gl-button
				appearance="primary"
				density="tight"
				href="${Ba(ua.PlusSignUp,this.source)}"
				>Start ${ti}-day Pro Trial</gl-button
			>
			&nbsp;or <a href="${Ba(ua.PlusLogin,this.source)}" title="Sign In">sign in</a>
		</div>`}renderUpgradeActions(e){const t=ri(this.state,"badge");return ne`<div class="actions">
			${e??ae}
			<gl-button
				appearance="primary"
				density="tight"
				href="${Ba(ua.PlusUpgrade,this.source)}"
				>Upgrade to Pro</gl-button
			>
			${this.renderPromo(t)}
		</div>`}renderPromo(e){return ne`<gl-promo .promo=${e}></gl-promo>`}};function Ba(e,t){return`command:${e}${t?`?${encodeURIComponent(JSON.stringify(t))}`:""}`}za.styles=[qo,Ho,p`
			:host {
				/* position: relative; */
				display: inline-block;
				--gl-feature-badge-color: currentColor;
		...
		`}};Ua.styles=[Ho,Qo,Zo,p``],Ma([ye({type:Object})],Ua.prototype,"badgeSource",2),Ma([r({context:ei,subscribe:!0}),we()],Ua.prototype,"_state",2),Ua=Ma([fe("gl-feature-nav")],Ua);var Va=Object.defineProperty,Ga=Object.getOwnPropertyDescriptor,qa=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?Ga(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&Va(t,o,r),r};let Ha=class extends lit_element_r{constructor(){super(...arguments),this.closed=!1}render(){return this.closed||this._state.hasAnyIntegrationConnected||this._state.integrationBannerCollapsed?ae:ne`
			<gl-card>
		...
		`}onClose(){this.closed=!0,this._ipc.sendCommand(Ie,{section:"integrationBanner",collapsed:!0})}focus(){this._button.focus()}};Ha.shadowRootOptions={...lit_element_r.shadowRootOptions,delegatesFocus:!0},Ha.styles=[p`
			gl-card::part(base) {
				margin-block-end: 1.2rem;
			}
		`],qa([r({context:ei,subscribe:!0}),we()],Ha.prototype,"_state",2),qa([r({context:xo,subscribe:!0}),we()],Ha.prototype,"_ipc",2),qa([we()],Ha.prototype,"closed",2),qa([ke("gl-button")],Ha.prototype,"_button",2),Ha=qa([fe("gl-integration-banner")],Ha);var Ka=Object.defineProperty,Qa=Object.getOwnPropertyDescriptor,Ja=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?Qa(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&Ka(t,o,r),r};let Ya=class extends lit_element_r{render(){if(this._state.showWalkthroughProgress)return ne`
		...
		`}onDismissWalkthrough(){this._state.showWalkthroughProgress=!1,this.requestUpdate(),this._ipc.sendCommand(Le)}onFallthroughClick(e){e.target?.closest("gl-button")||this._openWalkthroughButton.click()}};Ya.styles=[Qo,Xo],Ja([r({context:ei,subscribe:!0}),we()],Ya.prototype,"_state",2),Ja([r({context:xo,subscribe:!0}),we()],Ya.prototype,"_ipc",2),Ja([ke("#open-walkthrough")],Ya.prototype,"_openWalkthroughButton",2),Ya=Ja([fe("gl-onboarding")],Ya);var Za=Object.defineProperty,Xa=Object.getOwnPropertyDescriptor,el=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?Xa(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&Za(t,o,r),r};let tl=class extends lit_element_r{constructor(){super(...arguments),this.closed=!1}get isNewInstall(){return this._state.newInstall}render(){return!0!==this._state.previewEnabled?ne`
		...
		`}togglePreview(e=!1){this._ipc.sendCommand(De),e&&(this.closed=!0)}onClose(){this.closed=!0,this._ipc.sendCommand(Ie,{section:"newHomePreview",collapsed:!0})}focus(){this._button?.focus()}};tl.shadowRootOptions={...lit_element_r.shadowRootOptions,delegatesFocus:!0},tl.styles=[Ho,p`
			.text-button {
		...
		`],el([r({context:ei,subscribe:!0}),we()],tl.prototype,"_state",2),el([r({context:xo,subscribe:!0}),we()],tl.prototype,"_ipc",2),el([we()],tl.prototype,"closed",2),el([ke("button")],tl.prototype,"_button",2),tl=el([fe("gl-preview-banner")],tl);var ol=Object.defineProperty,il=Object.getOwnPropertyDescriptor,nl=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?il(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&ol(t,o,r),r};let rl=class extends lit_element_r{get hasPromos(){return null!=this.promo||void 0}get promo(){return ri(this._state.subscription.state,"home")}render(){return this.promo?ne`
		...
		`],nl([r({context:ei,subscribe:!0}),we()],rl.prototype,"_state",2),nl([ye({type:Boolean,reflect:!0,attribute:"has-promo"})],rl.prototype,"hasPromos",1),rl=nl([fe("gl-promo-banner")],rl);var sl=Object.defineProperty,al=Object.getOwnPropertyDescriptor,ll=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?al(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&sl(t,o,r),r};let cl=class extends GlElement{get hasAlerts(){return!0===this.alertVisibility.header||void 0}get alertVisibility(){const e={header:!1,untrusted:!1,noRepo:!1,unsafeRepo:!1};return null==this._state||this._state.discovering||(this._state.repositories.trusted?0===this._state.repositories.openCount?(e.header=!0,e.noRepo=!0):this._state.repositories.hasUnsafe&&(e.header=!0,e.unsafeRepo=!0):(e.header=!0,e.untrusted=!0)),e}render(){if(null!=this._state&&this.alertVisibility.header)return ne`
			${xe(this.alertVisibility.noRepo,(()=>ne`
				...
				`))}
			${xe(this.alertVisibility.unsafeRepo,(()=>ne`
				...
				`))}
			${xe(this.alertVisibility.untrusted,(()=>ne`
		...
		`],ll([ye({type:Boolean,reflect:!0,attribute:"has-alerts"})],cl.prototype,"hasAlerts",1),ll([r({context:ei,subscribe:!0}),we()],cl.prototype,"_state",2),cl=ll([fe("gl-repo-alerts")],cl);var dl=Object.defineProperty,hl=Object.getOwnPropertyDescriptor,pl=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?hl(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&dl(t,o,r),r};let ul=class extends GlApp{constructor(){super(...arguments),this.disposable=[],this.badgeSource={source:"home",detail:"badge"}}createStateProvider(e,t){return this.disposable.push(this._overviewState=new OverviewState(t)),new HomeStateProvider(this,e,t)}connectedCallback(){super.connectedCallback(),this.disposable.push(this._ipc.onReceiveMessage((e=>{if(!0===qe.is(e))this.accountContentEl.show()})))}disconnectedCallback(){super.disconnectedCallback(),this.disposable.forEach((e=>e.dispose()))}render(){return ne`
			<div class="home scrollable">
				<aside class="home__aux">
					<gl-promo-banner></gl-promo-banner>
					${xe(!this.state.previewEnabled,(()=>ne`<gl-preview-banner></gl-preview-banner>`))}
				</aside>
				<gl-repo-alerts class="home__alerts"></gl-repo-alerts>
				<main class="home__main scrollable" id="main">
					<gl-onboarding></gl-onboarding>
					${xe(!0===this.state?.previewEnabled,(()=>ne`
		...
		`}};ul.styles=[Qo,Ko,Jo],pl([n({context:Qt})],ul.prototype,"_overviewState",2),pl([ke("#account-content")],ul.prototype,"accountContentEl",2),ul=pl([fe("gl-home-app")],ul);var gl=i.K;export{gl as GlHomeApp};